...
const LDic = require("./GwentLocalizeDictionary.js"); // ローカライズの対応辞書のようなものを作成する自作関数
const GWENT = require("./GwentConstants.js"); // ローカライズファイルに記載されていないような基本的な用語対応辞書
...
class GwentCards {
  ...
  /*
  Template.xml を読み込み、関係するXMLノードをメンバ変数に代入
  ...
  /*
  Abilities.xml を読み込み、関係するXMLノードをメンバ変数に代入
  ...
  /*
  ArtDefinisions.xml を読み込み、関係するXMLノードをメンバ変数に代入
